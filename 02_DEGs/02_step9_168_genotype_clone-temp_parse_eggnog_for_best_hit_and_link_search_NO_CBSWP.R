...
setwd("C:/Users/NJCB/Documents/Purdue/daphnia_RNAseq/results/02_degs/degs_annotations_NO_CBSWP/168_genotype-clone.temp_NO_CBSWP_emapper_search_default/")
list.files()
...
dii <- read_tsv("./168.NO_CBSWP.genotype-clone.temp.annot.emapper.annotations", comment = "#", col_names = TRUE)
...
write.table(final_merged, "168.NO_CBSWP.genotype_clone-temp.merged_annotations.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep="\t", append = FALSE)
