...
write.table(genes.bed, "168.NO_CBSWP.genotype-clone.temp.bed", col.names = FALSE, row.names = FALSE, quote = FALSE, sep="\t", append = FALSE)
write.table(genes, "168.NO_CBSWP.genotype-clone.temp.annotated_genes_pre_blast.txt", col.names = TRUE, row.names = FALSE, quote = FALSE, sep="\t", append = FALSE)
