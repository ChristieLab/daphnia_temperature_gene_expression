#Pairwise DEG comparison between Daphnia clones in experimental treatment
...
m1 <- which(samples[, 8] == "hot" & samples[, 12] == "C1")
m2 <- which(samples[, 8] == "hot" & samples[, 12] == "C2")

m1 <- c(m1, m2)

samples[m1, ] # should all be hot and C1 and C2
...
saveRDS(dds, file="./exp_results/C1_C2_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C1_C2_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
m1 <- which(samples[, 8] == "hot" & samples[, 12] == "C1")
m2 <- which(samples[, 8] == "hot" & samples[, 12] == "C3")

m1 <- c(m1, m2)

samples[m1, ] # should all be hot and C1 and C3
...
saveRDS(dds, file="./exp_results/C1_C3_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C1_C3_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
m1 <- which(samples[, 8] == "hot" & samples[, 12] == "C1")
m2 <- which(samples[, 8] == "hot" & samples[, 12] == "C4")

m1 <- c(m1, m2)

samples[m1, ] # should all be hot and C1 and C4
...
saveRDS(dds, file="./exp_results/C1_C4_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C1_C4_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
m1 <- which(samples[, 8] == "hot" & samples[, 12] == "C1")
m2 <- which(samples[, 8] == "hot" & samples[, 12] == "C5")

m1 <- c(m1, m2)

samples[m1, ] # should all be hot and C1 and C5
...
saveRDS(dds, file="./exp_results/C1_C5_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C1_C5_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
m1 <- which(samples[, 8] == "hot" & samples[, 12] == "C1")
m2 <- which(samples[, 8] == "hot" & samples[, 12] == "C6")

m1 <- c(m1, m2)

samples[m1, ] # should all be hot and C1 and C6
...
saveRDS(dds, file="./exp_results/C1_C6_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C1_C6_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
m1 <- which(samples[, 8] == "hot" & samples[, 12] == "C2")
m2 <- which(samples[, 8] == "hot" & samples[, 12] == "C3")

m1 <- c(m1, m2)

samples[m1, ] # should all be hot and C2 and C3
...
saveRDS(dds, file="./exp_results/C2_C3_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C2_C3_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
samples[m1, ] # should all be hot and C2 and C4
...
saveRDS(dds, file="./exp_results/C2_C4_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C2_C4_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
samples[m1, ] # should all be hot and C2 and C5
...
saveRDS(dds, file="./exp_results/C2_C5_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C2_C5_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
samples[m1, ] # should all be hot and C2 and C6
...
saveRDS(dds, file="./exp_results/C2_C6_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C2_C6_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
m1 <- which(samples[, 8] == "hot" & samples[, 12] == "C3")
m2 <- which(samples[, 8] == "hot" & samples[, 12] == "C4")

m1 <- c(m1, m2)

samples[m1, ] # should all be hot and C3 and C4
...
saveRDS(dds, file="./exp_results/C3_C4_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C3_C4_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
samples[m1, ] # should all be hot and C3 and C5
...
saveRDS(dds, file="./exp_results/C3_C5_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C3_C5_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
samples[m1, ] # should all be hot and C3 and C6
...
saveRDS(dds, file="./exp_results/C3_C6_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C3_C6_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
m1 <- which(samples[, 8] == "hot" & samples[, 12] == "C4")
m2 <- which(samples[, 8] == "hot" & samples[, 12] == "C5")

m1 <- c(m1, m2)

samples[m1, ] # should all be hot and C4 and C5
...
saveRDS(dds, file="./exp_results/C4_C5_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C4_C5_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
samples[m1, ] # should all be hot and C4 and C6
...
saveRDS(dds, file="./exp_results/C4_C6_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C4_C6_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################
...
m1 <- which(samples[, 8] == "hot" & samples[, 12] == "C5")
m2 <- which(samples[, 8] == "hot" & samples[, 12] == "C6")

m1 <- c(m1, m2)

samples[m1, ] # should all be hot and C5 and C6
...
saveRDS(dds, file="./exp_results/C5_C6_exp.clone.rds")

res <- results(dds, alpha=0.05, pAdjustMethod = "BH", independentFiltering = TRUE)
length(which(res[, 6] < 0.05))
summary(res)
sink(file = "./exp_results/C5_C6_exp_DEG_summary.txt")
length(which(res[, 6] < 0.05))
summary(res)
sink(file = NULL)
####################################################################################################################