...
setwd("C:/Users/NJCB/Documents/Purdue/daphnia_RNAseq/results/updated_figures_02-23-25/mito_PCA/")
getwd()

#read in data
pca <- read_table("./all_samples_NO_BQSR_NO_CBSWP_SNPS_filterOut_clean_maf0.05_hwe0_geno0.1_mind0.2_recode_4.2_MITO.eigenvec", col_names = TRUE)
eigenval <- scan("./all_samples_NO_BQSR_NO_CBSWP_SNPS_filterOut_clean_maf0.05_hwe0_geno0.1_mind0.2_recode_4.2_MITO.eigenval")
...
#plot grid
setwd("~/Purdue/daphnia_RNAseq/figures_tables/MS_figures/MS_v1_figures_tables_submit/Sup_Figs/")
svg("Sup_Fig4_mitochondrial_PCA.svg", height=10,width=12)
grid.newpage()
